    ...
    <Stack spacing={4}>
        ...
        <Stack direction='row' spacing={2}>
          <TextField 
            ...
            helperText = {!value ? 'Required': 'Do not share your password with others'} />
        ...
        <Stack direction='row' spacing={2}>
          ...
          <TextField label='Password' type="password" InputProps={{endAdornment: <InputAdornment position="end"><VisibilityIcon/></InputAdornment>}}/>
        </Stack>
